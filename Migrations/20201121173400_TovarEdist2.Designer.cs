...
namespace WebJob.Migrations
{
    ...
    [Migration("20201121173400_TovarEdist2")]
    partial class TovarEdist2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebJob.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebJob.Data.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebJob.Models.Tovar", b =>
                {
                    b.HasOne("WebJob.Models.Category", "Category")
                        .WithMany("Tovars")
